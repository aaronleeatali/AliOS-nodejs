...
#define ASSEMBLE_ATOMIC_EXCHANGE_INTEGER(load_instr, store_instr)             \
  do {                                                                        \
    ...
    __ store_instr(i.InputRegister(1), i.InputRegister(2), i.TempRegister(0));\
    __ teq(i.InputRegister(1), Operand(0));                                   \
    __ b(ne, &exchange);                                                      \
    __ dmb(ISH);                                                              \
  } while (0)
...
#define ASSEMBLE_ATOMIC_COMPARE_EXCHANGE_INTEGER(load_instr, store_instr)     \
  do {                                                                        \
    ...
    __ b(ne, &exit);                                                          \
    __ store_instr(i.TempRegister(1), i.InputRegister(3), i.TempRegister(0)); \
...
#define ASSEMBLE_ATOMIC_BINOP(load_instr, store_instr, bin_instr)            \
  do {                                                                       \
    ...
    __ bind(&binop);                                                         \
    __ load_instr(i.OutputRegister(0), i.TempRegister(0));                   \
    __ bin_instr(i.InputRegister(2), i.OutputRegister(0),                    \

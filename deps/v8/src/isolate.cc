...
// <YUNOS> changed: begin
#ifdef ENABLE_JSAOT_
Isolate::Isolate(bool enable_serializer, WorkerRuntime* worker_runtime, bool enable_jso_range)
#else
...
// <YUNOS> changed: begin
#ifdef ENABLE_JSAOT_
      jso_range_enabled_(enable_jso_range),
#endif  // ENABLE_JSAOT_
      is_doing_aot_compilation_(false),
// <YUNOS> changed: end

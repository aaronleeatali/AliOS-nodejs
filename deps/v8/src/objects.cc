...
// <YUNOS> changed: begin
#ifdef ENABLE_JSAOT_
      } else if (IsUninitialized(isolate)) {
        os << "<uninitialized_value>";
#endif  // ENABLE_JSAOT_
// <YUNOS> changed: end
      } else {
        os << "<Odd Oddball: ";
...
// <YUNOS> changed: begin
#ifdef ENABLE_JSAOT_
  if (MemoryChunk::FromAddress(this->address())->IsFlagSet(
      MemoryChunk::AOT_COMPILED)) {
    DCHECK_EQ(age, kNoAgeBytecodeAge);
    return;
  }
#endif  // ENABLE_JSAOT_
// <YUNOS> changed: end

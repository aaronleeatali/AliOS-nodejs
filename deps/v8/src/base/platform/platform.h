...
class V8_BASE_EXPORT VirtualMemory {
 public:
  ...
  bool Commit(void* address, size_t size, bool is_executable, const char* name);
  // <YUNOS> changed: end
  ...
  // <YUNOS> changed: begin
  static bool CommitRegion(void* base, size_t size, bool is_executable, const char* name);
  // <YUNOS> changed: end

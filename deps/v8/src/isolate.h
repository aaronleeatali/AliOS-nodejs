...
// <YUNOS> changed: begin
#ifdef ENABLE_JSAOT_
  bool jso_range_enabled() const { return jso_range_enabled_; }
  bool is_doing_aot_compilation() const { return is_doing_aot_compilation_; }
  void set_is_doing_aot_compilation(bool value) {
    is_doing_aot_compilation_ = value;
  }
#endif  // ENABLE_JSAOT_
// <YUNOS> changed: end
...
// <YUNOS> changed: begin
#ifdef ENABLE_JSAOT_
  explicit Isolate(bool enable_serializer, WorkerRuntime* runtime = nullptr, bool enable_jso_range = false);
#else
...
// <YUNOS> changed: begin
#ifdef ENABLE_JSAOT_
  const bool jso_range_enabled_;
#endif  // ENABLE_JSAOT_

  // Whether it's doing AOT compilation in this isolate.
  bool is_doing_aot_compilation_;
// <YUNOS> changed: end

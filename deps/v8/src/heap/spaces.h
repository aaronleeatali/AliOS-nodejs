...
// <YUNOS> changed: begin
#ifdef ENABLE_JSAOT_
  void LinkCompiledPage(MemoryChunk* chunk, Space* owner);
#endif  // ENABLE_JSAOT_
// <YUNOS> changed: end
...
// <YUNOS> changed: begin
#ifdef ENABLE_JSAOT_
  JsoRange* jso_range() { return &jso_range_; }
#endif  // ENABLE_JSAOT_
// <YUNOS> changed: end
...
// <YUNOS> changed: begin
          ...
          !allocator_->jso_range_.Contains(chunk->address())) {
// <YUNOS> changed: end
#else
          (chunk->executable() != EXECUTABLE)) {
#endif  // ENABLE_JSAOT_
...
// <YUNOS> changed: begin
#ifdef ENABLE_JSAOT_
  void LinkCompiledPage(Page* page);
#endif  // ENABLE_JSAOT_
// <YUNOS> changed: end
...
// <YUNOS> changed: begin
#ifdef ENABLE_JSAOT_
  void LinkCompiledPage(LargePage* page);
#endif  // ENABLE_JSAOT_
// <YUNOS> changed: end
